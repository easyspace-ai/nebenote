...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to  MetaNote, an  super agent. With built-in and custom skills, MetaNote helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of MetaNote. With customized skills,\nMetaNote can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. MetaNote is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but MetaNote could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "MetaNote's official website",
    githubTooltip: "MetaNote on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "MetaNote on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About MetaNote",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to MetaNote",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate MetaNote faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how MetaNote looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "MetaNote automatically learns from your conversations in the background. These memories help MetaNote understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of MetaNote.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "MetaNote only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
